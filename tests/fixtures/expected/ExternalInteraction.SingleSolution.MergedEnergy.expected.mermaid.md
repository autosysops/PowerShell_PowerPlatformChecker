:::mermaid
graph LR;
solution_Energy["Energy"]:::Solution
...
externaldomain_internet -->|Flow-01 INBOUND Manual| solution_Energy
externaldomain_internet -->|Flow-02 INBOUND manual| solution_Energy
solution_Energy -->|Flow-02 GET CallApi_https| externaldomain_https_api_contoso_example
solution_Energy -->|App-01 Unknown C01 DomainUnresolved| shared_commondataserviceforapps
solution_Energy -->|App-01 Unknown C02 DomainUnresolved| shared_office365
