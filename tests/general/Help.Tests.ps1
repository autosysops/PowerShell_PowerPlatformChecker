...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\PowerPlatformChecker\functions", "$global:testroot\..\PowerPlatformChecker\internal\functions"),

	[string]
	$ModuleName = "PowerPlatformChecker",
...
$CommandPath = @(
    "$global:testroot\..\PowerPlatformChecker\functions"
    "$global:testroot\..\PowerPlatformChecker\internal\functions"
)
