function Get-PowerPlatformCheckerAppModelDriven {
    <#
    .SYNOPSIS
    ...
    .EXAMPLE
        ...
        PS> Get-PowerPlatformCheckerAppModelDriven -SolutionPath "C:\Solutions\MySolution"
    ...
    .EXAMPLE
        ...
        PS> Get-PowerPlatformCheckerAppModelDriven -SolutionPath "C:\Solutions\MySolution" -Name "contoso_*"
    #>
    ...
    $results = foreach ($appFile in $appFiles) {
        ...
        if ($uniqueName -notlike $Name -and $displayName -notlike $Name) {
            continue
        }
